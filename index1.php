...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #940F97,#B71EBA,#D2C1ED); background-size: cover;">
    ...
    <div class="container-fluid" style="margin-top:60px;margin-bottom:60px;color:#940F97;">
      <div class="row">
      ...
      <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="card-body">
              <center>
                <i class="fa fa-hospital-o fa-3x" aria-hidden="true" style="color:#940F97"></i>
                <br>
